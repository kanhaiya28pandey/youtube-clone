...
export default function CallPage() {
  ...
  const [isEndingCall, setIsEndingCall] =
    useState(false);
  ...
  const startRecording = async () => {
    try {
      ...
      if (
        ...
        alert(
          "Please wait until your friend joins the call."
        );
      ...
      <div className="w-full flex justify-center px-3 sm:px-5 lg:px-8">
        ...
        <main className="w-full max-w-7xl py-5 sm:py-6 lg:py-8">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-5 sm:mb-6">
            ...
            <div className="min-w-0">
              ...
              <div className="flex flex-wrap items-center gap-2 mt-1">
                ...
                <p className="text-xs sm:text-sm text-gray-400 truncate max-w-[220px] sm:max-w-none">
                  Room: {roomId}
                </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-5 lg:gap-6">
            ...
            <div className="relative bg-[#111] rounded-2xl overflow-hidden aspect-video border border-gray-800 shadow-lg">
              ...
              {!remoteConnected && (
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#111] px-4 text-center">

                  <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gray-800 flex items-center justify-center mb-4">
              ...
              {remoteCameraOff &&
                remoteConnected && (
                  <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#111]">
                    ...
                    <div className="w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-gray-800 flex items-center justify-center mb-3">
          ...
          <div className="sticky bottom-3 sm:bottom-4 z-20 flex justify-center mt-5 sm:mt-6 px-2">
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3 bg-[#181818]/95 backdrop-blur-xl border border-gray-800 rounded-2xl px-3 py-3 shadow-2xl">
          ...
          <p className="text-center text-xs sm:text-sm text-gray-500 mt-4 px-3 max-w-2xl mx-auto leading-relaxed">

            To share YouTube, choose the YouTube browser
            tab when your browser asks what you want to
            share.
